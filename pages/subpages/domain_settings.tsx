    ...
    <>
        ...
        {mailboxes.length === 0 ? (
            ...
            {mailboxesToShow.map((mailbox: any, index: any) => (
              <MailboxCard key={index} id={mailbox.mailbox_id} fqe={mailbox.fqe} quota_used={mailbox.quota_used} quota={mailbox.quota} mails={mailbox.messages} active={mailbox.active} created={mailbox.created_at} />
            ))}
            </div>
